...
export interface StudentCandidateMatch { student: StudentCareerPassport; candidateFitScore: number; matchedSkills: string[]; missingSkills: string[]; alignmentPoints: string[]; aiRecommendation: string; visibilityDenied?: boolean; visibilityStatus?: 'approved' | 'denied' | 'pending'; redactedReason?: string; }
