        ...
        <form onSubmit={handleSubmit} className="p-6 space-y-6 max-h-[80vh] overflow-y-auto font-sans">
          ...
          <div className="bg-[#181818] p-4 border border-[#333333] space-y-3">
            ...
            <textarea
              ...
              className="w-full bg-[#111111] text-xs font-mono text-white p-3 border border-[#333333] focus:border-[#CCFF00] focus:outline-none resize-none"
            />
              ...
              <div className="flex flex-wrap gap-1.5">
                {samplePrompts.map((p, idx) => (
                  <button
                    ...
                    className="text-[10px] font-mono bg-[#111111] hover:bg-[#222222] text-[#AAAAAA] hover:text-white px-2.5 py-1 border border-[#282828] text-left transition-colors cursor-pointer"
                  >
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
            <div className="sm:col-span-2">
              <label htmlFor="job-role-title-input" className="block text-xs font-mono font-bold text-[#AAAAAA] uppercase mb-1">
                Role Title
              </label>
              <input
            ...
            <div>
              <label htmlFor="vacancies-count-input" className="block text-xs font-mono font-bold text-[#AAAAAA] uppercase mb-1">
            ...
            <div>
              <label htmlFor="joining-window-input" className="block text-xs font-mono font-bold text-[#AAAAAA] uppercase mb-1">
            ...
            <div className="sm:col-span-2">
              <label htmlFor="target-academic-branches-input" className="block text-xs font-mono font-bold text-[#AAAAAA] uppercase mb-1">
            ...
            <div className="sm:col-span-2">
              <label htmlFor="required-skills-input" className="block text-xs font-mono font-bold text-[#AAAAAA] uppercase mb-1">
            ...
            <div className="sm:col-span-2">
              <label htmlFor="job-locations-input" className="block text-xs font-mono font-bold text-[#AAAAAA] uppercase mb-1">
            ...
            <div>
              <label htmlFor="salary-min-lpa-input" className="block text-xs font-mono font-bold text-[#AAAAAA] uppercase mb-1">
                Min Salary (LPA)
              </label>
              <input
            ...
            <div>
              <label htmlFor="salary-max-lpa-input" className="block text-xs font-mono font-bold text-[#AAAAAA] uppercase mb-1">
                Max Salary (LPA)
              </label>
              <input
            ...
            <div className="sm:col-span-2">
              <label htmlFor="ideal-candidate-profile-summary" className="block text-xs font-mono font-bold text-[#AAAAAA] uppercase mb-1">
          ...
          <div className="flex items-center justify-end space-x-3 pt-4 border-t border-[#222222]">
            <button
              type="button"
              onClick={onClose}
              className="px-4 py-2 text-xs font-mono text-[#888888] hover:text-white uppercase transition-colors cursor-pointer"
            >
              Cancel
            </button>
            <button
              ...
              className="px-6 py-2.5 bg-[#CCFF00] hover:bg-[#b8e600] text-black font-mono font-black uppercase text-xs tracking-wider transition-all flex items-center space-x-2 cursor-pointer shadow-lg"
            >
