...
export const Header: React.FC = () => {
  ...
  const roleTabs: { id: UserRole; label: string; sub: string; num: string; icon: React.ReactNode }[] = [
    ...
    },
    {
      ...
      sub: 'Talent Unit & Consent',
      num: '03',
      icon: <GraduationCap className="w-3.5 h-3.5" />,
    },
    {
      id: 'simulation',
      label: 'Interactive Loop',
      sub: '23-Principle Flow',
      num: '04',
  ...
  return (
    <header className="bg-[#0A0A0A] border-b border-[#222] text-[#F5F5F5] sticky top-0 z-50">
      {/* Top Bar with Bold Typography Brand & Stats */}
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div>
              <div className="flex items-center gap-2">
                <span className="text-[#CCFF00] font-mono text-[10px] tracking-widest uppercase">
                  Talent Orchestration Engine v2.4
                </span>
                <span className="text-[#444] font-mono text-[10px]">|</span>
                <span className="text-[#888] font-mono text-[10px] uppercase">
                  Verified Talent Graph
                </span>
              </div>
              <h1 className="text-2xl sm:text-3xl font-black leading-none tracking-tighter uppercase italic text-white flex items-center gap-2">
                Campus <span className="text-[#CCFF00]">Exchange</span>
              </h1>
            </div>
          </div>

          {/* Network Health Indicators in Bold Typography Monospace */}
          <div className="flex items-center gap-4 sm:gap-6 flex-wrap">
            <div className="text-right">
              <p className="text-[#888] text-[9px] font-mono uppercase tracking-widest">Network Status</p>
            ...
            <div className="text-right border-l border-[#222] pl-4 sm:pl-6">
              <p className="text-[#888] text-[9px] font-mono uppercase tracking-widest">Demands</p>
              <p className="text-white font-mono text-sm sm:text-base font-bold">{totalDemands.toLocaleString()}</p>
            </div>
            <div className="text-right border-l border-[#222] pl-4 sm:pl-6">
              <p className="text-[#888] text-[9px] font-mono uppercase tracking-widest">Calls for Talent</p>
            ...
            <div className="text-right border-l border-[#222] pl-4 sm:pl-6 hidden sm:block">
              <p className="text-[#888] text-[9px] font-mono uppercase tracking-widest">Consented Talent</p>
            ...
            <div className="text-right border-l border-[#222] pl-4 sm:pl-6 hidden md:block">
              <p className="text-[#888] text-[9px] font-mono uppercase tracking-widest">Placements</p>
        ...
        <div className="flex flex-col lg:flex-row lg:items-center justify-between py-3 gap-3">
              ...
              return (
                ...
                >
                  ...
                  <div className="text-left flex items-center gap-1.5">
                    ...
                    <span className={`text-[9px] uppercase tracking-wider font-mono hidden xl:inline ${
                      isActive ? 'text-black/80' : 'text-[#666]'
                    }`}>
                      [{tab.sub}]
                    </span>
                  </div>
          ...
          {/* Sub-Entity Selector in Bold Typography */}
          <div className="flex items-center space-x-2 text-xs w-full lg:w-auto justify-end font-mono">
            <span className="text-[#666] text-[10px] uppercase tracking-widest flex items-center gap-1 whitespace-nowrap">
              <ArrowRightLeft className="w-3 h-3 text-[#CCFF00]" />
            ...
            {activeRole === 'simulation' && (
              <span className="px-2.5 py-1 bg-[#181818] text-[#CCFF00] font-mono text-[10px] uppercase tracking-wider font-bold border border-[#333]">
                ⚡ 23-Principle Interactive Execution
              </span>
            )}
          </div>
        </div>
